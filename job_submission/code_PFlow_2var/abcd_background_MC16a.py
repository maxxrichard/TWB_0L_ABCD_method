...
def makeHists(background,dsid,chain_name,crossection_background,label,weight_branch):
    ...
    if "3123" in background:
        print "-------------------------------------------------------------------------------------------------------------- \n"
        print "\t \t SIGNAL \n"
        signal_array_element = 28
        allowed_Ks = [0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6]
        crossection_background = crossection_background * allowed_Ks[signal_array_element-20] * allowed_Ks[signal_array_element-20]
    else:
        print "-------------------------------------------------------------------------------------------------------------- \n"
        print "\t \t BACKGROUND \n"
    ...
    for l in xrange(nominal.GetEntries()):
        ...
        if "3123" in background:
            weight_sig = getattr(nominal,"mc_generator_weights")
        ...
        if forward == True:
            ...
            elif len(jetpt_btag) == 1000 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 120e3 and tight[idx_ljet] == 1 and jetpt[idx_jet] > 350e3 and leadjetpt[idx_ljet] > 500e3 and (tag2015_tight == 1 or tag2016_tight == 1): #1b_tight_Wtagged
            ...
            elif len(jetpt_btag) == 1000 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 120e3 and loose[idx_ljet] == 1 and tight[idx_ljet] != 1 and jetpt[idx_jet] > 350e3 and leadjetpt[idx_ljet] > 500e3 and ((tag2015_loose == 1 and tag2015_tight != 1) or (tag2016_loose == 1 and tag2016_tight != 1)): #1b_loose_not_tight_Wtagged
                #print tight[idx_ljet],loose[idx_ljet],leadjetpt[idx_ljet],jetpt[idx_jet],len(jetpt_btag)
            ...
            elif len(jetpt_btag) == 1000 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 120e3 and loose[idx_ljet] != 1 and jetpt[idx_jet] > 350e3 and leadjetpt[idx_ljet] > 500e3:
