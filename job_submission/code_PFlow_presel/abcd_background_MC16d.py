...
def makeHists(background,dsid,chain_name,crossection_background,label,weight_branch,signal_array):
    ...
    for l in xrange(nominal.GetEntries()):
        ...
        if forward == True:
            if len(jetpt_btag) == 1000 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 120e3 and tight[idx_ljet] == 1 and jetpt[idx_jet] > 350e3 and leadjetpt[idx_ljet] > 500e3 and tag2017_tight == 1: #2b_tight_Wtagged
            ...
            elif len(jetpt_btag) == 1000 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 120e3 and tight[idx_ljet] == 1 and jetpt[idx_jet] > 350e3 and leadjetpt[idx_ljet] > 500e3 and tag2017_tight_0b == 1: #0b_tight_Wtagged
            ...
            elif len(jetpt_btag) == 1000 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 120e3 and loose[idx_ljet] == 1 and tight[idx_ljet] != 1 and jetpt[idx_jet] > 350e3 and leadjetpt[idx_ljet] > 500e3 and (tag2017_loose_0b == 1 and tag2017_tight_0b != 1): #0b_loose_not_tight_Wtagged
                #print tight[idx_ljet],loose[idx_ljet],leadjetpt[idx_ljet],jetpt[idx_jet],len(jetpt_btag)
