...
def makeHists(background,dsid,chain_name,crossection_background,label):
    lumi = 36209.04
    
    location = '/cephfs/user/s6anband/ntuples/'

    tagger = ['allhad_2015_2var50_btag70','allhad_2016_2var50_btag70','allhad_2015_2var50','allhad_2016_2var50','allhad_2015_2var80_btag70','allhad_2016_2var80_btag70','allhad_2015_2var80','allhad_2016_2var80']

    file_names = []

    print background,dsid,crossection_background
    ...
    for l in xrange(nominal.GetEntries()):
        ...
        leadjet_2varW80 = getattr(nominal,'ljet_good_2VarW80')
        leadjet_2varW50 = getattr(nominal,'ljet_good_2VarW50')
        ...
        weight_0b = weight
        weight *= getattr(nominal,'weight_bTagSF_MV2c10_70')
        ...
        for x in xrange(leadjet_pt.size()):
            ...
            leadjet2varW80.append(leadjet_2varW80[x])
            leadjet2varW50.append(leadjet_2varW50[x])
        ...
        leadjet2varW80 = np.array(leadjet2varW80)
        leadjet2varW50 = np.array(leadjet2varW50)
        tight = leadjet2varW50
        loose = leadjet2varW80
        top = leadjetdnnW80
        ...
        if forward == True:
            if len(jetpt_btag) > 0 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and tight[idx_ljet] == 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and (tag2015_tight == 1 or tag2016_tight == 1): #2b_tight_Wtagged
                #tight[idx_ljet] == 1, met_met < 200e3, DeltaR_bjet > 0.8
            ...
            elif len(jetpt_btag) == 1000 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and tight[idx_ljet] == 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and (tag2015_tight == 1 or tag2016_tight == 1): #1b_tight_Wtagged
            ...
            elif len(jetpt_btag) == 0 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and tight[idx_ljet] == 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and (tag2015_tight_0b == 1 or tag2016_tight_0b == 1): #0b_tight_Wtagged
            ...
            elif len(jetpt_btag) > 0 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] == 1 and tight[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and ((tag2015_loose == 1 and tag2015_tight != 1) or (tag2016_loose == 1 and tag2016_tight != 1)): #2b_loose_not_tight_Wtagged
            ...
            elif len(jetpt_btag) == 1000 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] == 1 and tight[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and ((tag2015_loose == 1 and tag2015_tight != 1) or (tag2016_loose == 1 and tag2016_tight != 1)): #1b_loose_not_tight_Wtagged
                #print tight[idx_ljet],loose[idx_ljet],leadjetpt[idx_ljet],jetpt[idx_jet],len(jetpt_btag)
            ...
            elif len(jetpt_btag) == 0 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] == 1 and tight[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and ((tag2015_loose_0b == 1 and tag2015_tight_0b != 1) or (tag2016_loose_0b == 1 and tag2016_tight_0b != 1)): #0b_loose_not_tight_Wtagged
                #print tight[idx_ljet],loose[idx_ljet],leadjetpt[idx_ljet],jetpt[idx_jet],len(jetpt_btag)
            ...
            elif len(jetpt_btag) > 0 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3: #2b_not_loose_Wtagged
            ...
            elif len(jetpt_btag) == 1000 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3:
            ...
            elif len(jetpt_btag) == 0 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3: #0b_not_loose_Wtagged
    ...
    ljet_pt_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_eta_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_phi_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_m_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_e_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_n_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_pt_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_eta_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_phi_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_m_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_e_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_n_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_pt_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_eta_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_phi_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_m_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_e_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    VLQM_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    DeltaR_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    DeltaPhi_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    DeltaR_bjet_lead_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    DeltaR_bjet_sub_1b_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ...
    ljet_pt_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_eta_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_phi_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_m_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_e_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_n_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_pt_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_eta_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_phi_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_m_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_e_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_n_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_pt_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_eta_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_phi_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_m_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_e_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    VLQM_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    DeltaR_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    DeltaPhi_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    DeltaR_bjet_lead_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    DeltaR_bjet_sub_1b_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ...
    ljet_pt_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_eta_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_phi_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_m_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_e_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ljet_n_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_pt_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_eta_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_phi_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_m_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_e_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_n_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_pt_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_eta_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_phi_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_m_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    sub_ljet_e_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    VLQM_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    DeltaR_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    DeltaPhi_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    DeltaR_bjet_lead_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    DeltaR_bjet_sub_1b_not_loose_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    ...
    jet_pt_nb_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_eta_nb_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)


    jet_pt_nb_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
    jet_eta_nb_loose_not_tight_Wtagged.Scale(crossection_background*lumi/sumofeventsweighted)
...
label = sys.argv[5]
print type(dsid)
makeHists(background,dsid,chain_name,crossection_background,label)