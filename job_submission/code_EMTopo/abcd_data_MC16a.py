...
def makeHists(data,dsid,label):
    ...
    for l in xrange(nominal.GetEntries()):
        ...
        if forward == True:
            ...
            elif len(jetpt_btag) == 1000 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and (tag2015 == 1 or tag2016 == 1): #1b_not_loose_Wtagged
