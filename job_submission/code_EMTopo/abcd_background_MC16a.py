...
def makeHists(background,dsid,chain_name,crossection_background,label,weight_branch):
    lumi = 36209.04
    
    location = '/cephfs/user/s6anband/ntuples/'

    tagger = ['allhad_2015_3var50_btag70','allhad_2016_3var50_btag70','allhad_2015_3var50','allhad_2016_3var50','allhad_2015_3var80_btag70','allhad_2016_3var80_btag70','allhad_2015_3var80','allhad_2016_3var80','allhad_2015','allhad_2016']
    ...
    if "3647" in background:
        ...
        for j in xrange(sumWeights.GetEntries()):
            ...
            sumweight = getattr(sumWeights,"totalEventsWeighted")
            sumofeventsweighted += sumweight
    #os.chdir("/cephfs/user/s6marahm/output_"+weight_branch+"/")
    os.chdir("/cephfs/user/s6marahm/output_PFlow/")
    ...
    for l in xrange(nominal.GetEntries()):
        ...
        tag2015 = getattr(nominal,tagger[8])
        tag2016 = getattr(nominal,tagger[9])
        ...
        weight *= getattr(nominal,weight_branch)
        ...
        if forward == True:
            ...
            elif len(jetpt_btag) > 0 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and (tag2015 == 1 or tag2016 == 1): #2b_not_loose_Wtagged
            ...
            elif len(jetpt_btag) == 1000 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and (tag2015 == 1 or tag2016 == 1):
            ...
            elif len(jetpt_btag) == 0 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and (tag2015 == 1 or tag2016 == 1): #0b_not_loose_Wtagged
...
print type(dsid)
makeHists(background,dsid,chain_name,crossection_background,label,weight_branch)