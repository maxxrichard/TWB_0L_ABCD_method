...
def makeHists(background,dsid,chain_name,crossection_background,label,weight_branch):
    ...
    tagger = ['allhad_2018_3var50_btag70','allhad_2018_3var50','allhad_2018_3var80_btag70','allhad_2018_3var80','allhad_2018']
    ...
    for l in xrange(nominal.GetEntries()):
        ...
        tag2018 = getattr(nominal,tagger[4])
        ...
        if forward == True:
            ...
            elif len(jetpt_btag) > 0 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and tag2018 == 1: #2b_not_loose_Wtagged
                #and tag2018_loose != 1
            ...
            elif len(jetpt_btag) == 1000 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and tag2018 == 1: #1b_not_loose_Wtagged
            ...
            elif len(jetpt_btag) == 0 and abs(jeteta[idx_jet]) < 2.5 and DeltaR > 1.0 and met_met < 200e3 and loose[idx_ljet] != 1 and jetpt[idx_jet] > 200e3 and leadjetpt[idx_ljet] > 500e3 and tag2018 == 1: #0b_not_loose_Wtagged
