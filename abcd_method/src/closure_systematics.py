...
def makeHists(corr_type,corr_cal):
    ...
    f5 = ROOT.TFile.Open("/cephfs/user/s6marahm/output/abcd_output_dijets_closure_uncertainity.root","RECREATE")
        ...
        for t in tagger_calculated:
            for v in variable_calculated:
                ...
                if(corr_type == "integral"):
                    ...
                    if(t == 'loose_not_tight_Wtagged'):
                        print "Validation Region"
                        if(v == 'ljet_pt'):
                            #temp.Scale(float(72071.6/58902.1))
                            temp.Scale(1.30279)
                            print k
                        elif(v == 'jet_pt'):
                            #temp.Scale(float(71669.7/34289.9))
                            temp.Scale(1.54830)
                            print k
                        elif(v == 'VLQM'):
                            #temp.Scale(float(72572.6/52738.3))
                            temp.Scale(1.30641)
                            print k
                        elif(v == 'ljet_eta'):
                            #temp.Scale(float(72613/59597.5))
                            temp.Scale(1.27202)
                            print k
                        elif(v == 'ljet_m'):
                            #temp.Scale(float(72752.4/85592.5))
                            temp.Scale(0.94719)
                            print k
                        elif(v == 'jet_m'):
                            #temp.Scale(float(73038.4/100723))
                            temp.Scale(0.97083)
                            print k
                    else:
                        print "Signal Region"
                        if(v == 'ljet_pt'):
                            #temp.Scale(float(12680.6/11689.5))
                            temp.Scale(1.21208)
                            print k
                        elif(v == 'jet_pt'):
                            #temp.Scale(float(14883.9/6961.26))
                            temp.Scale(1.48025)
                            print k
                        elif(v == 'VLQM'):
                            #temp.Scale(float(12327.2/10927.6))
                            temp.Scale(1.17615)
                            print k
                        elif(v == 'ljet_eta'):
                            #temp.Scale(float(12633.9/11865.8))
                            temp.Scale(1.16324)
                            print k
                        elif(v == 'ljet_m'):
                            #temp.Scale(float(12440/16656.4))
                            temp.Scale(0.81249)
                            print k
                        elif(v == 'jet_m'):
                            #temp.Scale(float(13009.9/19509.3))
                            temp.Scale(0.86003)
                            print k
